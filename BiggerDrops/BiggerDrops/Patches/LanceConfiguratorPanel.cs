...
namespace BiggerDrops.Patches
{
    ...
    public static class LanceConfiguratorPanel_SetData
    {
        public static void UpdateSlotsCount(this LanceConfiguratorPanel panel, int maxUnits)
        {
            try
            {
                ...
                if (newLayoutTransform == null)
                {
                    ...
                    newLayout = UnityEngine.Object.Instantiate(primelayout);
        ...
        public static void Prefix(LanceConfiguratorPanel __instance, ref int maxUnits, Contract contract)
        {
            try
            {
                if (contract != null)
    ...
    public static void Postfix(LanceConfiguratorPanel __instance, ref int maxUnits, Contract contract)
        {
            try
            {
                if (contract == null)
    ...
    {
        public static void Prefix(LanceConfiguratorPanel __instance, string lanceId)
        {
        ...
        public static void Postfix(LanceConfiguratorPanel __instance, string lanceId, ref LanceDef __result)
        {
            LanceLoadoutSlot[] loadoutSlots = (LanceLoadoutSlot[])AccessTools.Field(typeof(LanceConfiguratorPanel), "loadoutSlots").GetValue(__instance);
        }
    }
    ...
    public static void Postfix(LanceConfiguratorPanel __instance, ref LanceConfiguration __result, LanceLoadoutSlot[] ___loadoutSlots)
        {
            try
            {
                //if (CustomUnitsAPI.Detected()) { return; }
                Fields.callsigns.Clear();
                LanceConfiguration lanceConfiguration = new();
